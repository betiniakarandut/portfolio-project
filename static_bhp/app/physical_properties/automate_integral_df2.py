...
def compute_denominator_sciv():
    ...
    """
    above = sciv_for_cell_above_ppr()
    below = sciv_for_cell_below_ppr()
...
def compute_the_value_of_unknown_sciv():
    ...
    """
    above = sciv_for_cell_above_ppr()
    below = (compute_denominator_sciv() * interpolated_ppr())
    computed_sciv = above - below
